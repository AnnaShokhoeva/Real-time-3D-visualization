...
function main() 
{
  ...
  const vertices = [
    ...
    // Hole in the left face
    { pos: [-1, -0.5, -0.5], norm: [-1, 0, 0], uv: [0.25, 0.25] }, // 36
    { pos: [-1, -0.5,  0.5], norm: [-1, 0, 0], uv: [0.75, 0.25] }, // 37
    { pos: [-1,  0.5, -0.5], norm: [-1, 0, 0], uv: [0.25, 0.75] }, // 38
    { pos: [-1,  0.5,  0.5], norm: [-1, 0, 0], uv: [0.75, 0.75] }, // 39
  ];
